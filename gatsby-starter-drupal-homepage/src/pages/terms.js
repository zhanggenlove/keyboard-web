            ...
            <div className="row justify-content-center">
              <div className="col-xl-7 col-lg-9">
                <div className="terms-con-content-1">
                  <div>更新日期：<strong>2022/9/2</strong></div>
                  <div>生效日期：<strong>2022/9/2</strong></div>
                  <h2>导言</h2>
                  <p>
                    <i>快捷键盘</i> 是一款由 <i>zhanggen</i> （以下简称“我们”）提供的产品。
                    您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。
                    本《隐私政策》与您所使用的 <i>快捷键盘</i> 服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。
                  </p>
                  <p><strong>您使用或继续使用我们的服务，即意味着同意我们按照本《隐私政策》收集、使用、储存和分享您的相关信息。</strong></p>
                  <p>如对本《隐私政策》或相关事宜有任何问题，请通过 <strong>zhanggenlove@gmail.com</strong> 与我们联系。</p>
                ...
                <div className="terms-license-area">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <span>✓</span>{" "}
                      通过电子邮件、聊天和社交媒体提供行业领先的客户支持
                    </li>
                    <li>
                      <span>✓</span> 通过采取积极主动的方法来改善客户体验
                    </li>
                    <li>
                      <span>✓</span> 协助制定客户支持程序、政策和标准
                    </li>
                    <li>
                      <span>✓</span> 掌握问题并跟踪问题直至解决。
                    </li>
                  </ul>
                </div>
                ...
                <div className="terms-con-content-3">
                  <h4>关于条款的更改</h4>
                  <p>
                    如果我们更改使用条款，我们将在此页面上发布这些更改。注册用户将收到一封电子邮件，其中概述了对使用条款所做的更改。
                  </p>
                </div>
              </div>
            </div>
